...
/*Original author: Florian Isikci <florian.isikci@vhiterabbit.com> */
...
WL.registerComponent('waypoint-movement', {
    ...
    _setCurvePoints: function(){
      ...
      * p2 = B + cD * (C-B)
      */ 
      vec3.sub(this.currentPosition, this.positions[this.currentCurveIndex], this.positions[this.currentCurveIndex + 1])
      ...
      vec3.sub(this.currentPosition, this.positions[this.currentCurveIndex + 2], this.positions[this.currentCurveIndex + 1])
      vec3.scale(this.currentPosition, this.currentPosition, this.curveDistance);
    ...
    update: function(dt) {
      ...
      if(Math.abs(factor - Math.round(factor)) < this.curveDistance && !(this.currentPositionIndex == this.children.length-2 && factor > 0.5) && !(this.currentPositionIndex == 0 && factor < 0.5)) {
        ...
        vec3.bezier(this.currentPosition, this.p0, this.p1,this.p1, this.p2, bezFactor);
        // position ahead of the object on the path, determines the looking direction
        vec3.bezier(this.lookPosition, this.p0, this.p1,this.p1, this.p2, bezFactor+0.01);
      } else {
